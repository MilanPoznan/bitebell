...
const PrevArrow = ({ onClick, activeClick }) => <svg className='arr-left-desktop' width="38" height="26" viewBox="0 0 38 26" fill="none" xmlns="http://www.w3.org/2000/svg"
  onClick={() => {
    onClick()
    activeClick()
  }}>
...
const NextArrow = ({ onClick, activeClick }) => <svg className={`arr-right-desktop `} width="38" height="26" viewBox="0 0 38 26" fill="none" xmlns="http://www.w3.org/2000/svg"
  onClick={() => {
    onClick()
    activeClick()
  }}>
