...
import { SelectWrapper, SingleOption, FilterWrapper, DesktopWrapper, SelectFilter, AccordionWrapper, FaqSearch, FaqInput, FaqHeader, Title, Subtitle, FaqContainer } from './Faq.styled'

export default function FaqTemplate({ title, subtitle, accordionArray }) {
  ...
  return (
    <FaqContainer>
      ...
      <DesktopWrapper>
        ...
        <FilterWrapper>
          <p style={{ fontSize: "20px", marginBottom: '14px' }}>Topic</p>
